...
//            }
                ...
                for (Element box1 : box) {
                    ...
                    if (priceInBox > product.min_price && priceInBox < product.max_price) {
                        comparePriceLink = box1.select("a.compare-link-1");//strona porownaj cene- kilka ofert na Skapiec.pl
                        System.out.println(comparePriceLink.text());
                        if(comparePriceLink.text().isEmpty()){
                            comparePriceLink = box1.select("a.more-info");
                            System.out.println("ygfu"+ comparePriceLink.text());
                        }
                        System.out.println(priceInBox);
                        System.out.println("https://www.skapiec.pl"+comparePriceLink.attr("href"));
